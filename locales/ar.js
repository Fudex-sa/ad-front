...
const messages = {
  ...
  home_page:'الرئيسية',
  i_am_publisher:'أنا ناشر',
  i_am_advertiser:'أنا معلن',  
  publisher_home_msg:'أريد الإستفادة من موقعي، مدونتي، او نشاطي على الشبكات الإجتماعية',  
  advertiser_home_msg:'أريد زيادة مبيعاتي، تأثير تجارتي، و أرباحي',
  join_team:'الإلتحاق بنا',
  publisher_video:'فيديو الناشر',
  advertiser_video:'فيديو المعلن',
  download_our_apps:'حمل تطبيقاتنا',
  footer_col_1:'الفوتر يمين',
  footer_col_2:'الفوتر وسط',
  footer_col_3:'الفوتر يسار',
  x:'',
  x:'',
  x:'',
  x:'',
