...
<div class="row">
    ...
    <div class="col-sm-12">
        <div class="form-group dash-group">
            ...
            <p class="text-danger p-2" v-for="error in errors.username" :key="error">{{error}}</p>
        </div>
    </div>
    <div class="col-sm-12">
        <div class="form-group dash-group">
    ...
    <div class="col-sm-12 col-md-6">
        <div class="form-group dash-group">
            ...
            <p class="text-danger p-2" v-for="error in errors.password" :key="error">{{error}}</p>
        </div>
    </div>
    <div class="col-sm-12 col-md-6">
        <div class="form-group dash-group">
    ...
    <div class="col-sm-12 col-md-6">
        <div class="form-group dash-group">
            ...
            <p class="text-danger p-2" v-for="error in errors.slug" :key="error">{{error}}</p>
        </div>
    </div>
    <div class="col-sm-12 col-md-6" v-if=" form.slug == 'Advertiser' ">
        <div class="form-group dash-group">
            ...
            <p class="text-danger p-2" v-for="error in errors.company" :key="error">{{error}}</p>
        </div>
    </div>
...
export default {
    ...
    methods: {
        handleSubmition() {
            this.$axios.$post('users/create', this.form)
                .then(res => {
